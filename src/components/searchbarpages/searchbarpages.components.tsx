    ...
    return (
        <div>
            ...
            <ModalItem
                ...
                onClose={closeModal}
                modalClassName='z-[-1]'
                boxClassName='w-[600px] h-[500px] bg-backgroundopacity80 back rounded-2xl flex items-center shadow-md border border-foregroundopacity20'
                color='white'
            >
                <div className='w-full flex justify-center border-b border-foregroundopacity20 p-1'>
                    <SearchBar onSearch={handleModalSearch} placeholder="O que deseja buscar hoje?"
